...
const renderProfileSvgLink = (href: string, svgPath: string) => {
  return (
    <Link href={href} className="text-gray-500 hover:opacity-60">
      <svg viewBox="0 0 24 24" className="fill-current w-6 h-6" xmlns="http://www.w3.org/2000/svg">
        <path d={svgPath} />
      </svg>
    </Link>
  );
